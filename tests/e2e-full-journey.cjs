...
if (IS_PROD && process.env.ALLOW_PRODUCTION_TESTS !== "true") {
  console.error("ERROR: Refusing to run E2E against production without ALLOW_PRODUCTION_TESTS=true");
  console.error("  This test creates real users/clients. Set ALLOW_PRODUCTION_TESTS=true to opt in.");
  process.exit(1);
}
