...
// ══════════════════════════════════════════════════════════════════════════════
// LAYER 2 — LIVE KNOWLEDGE ENGINE
// getEmbeddedKnowledge2025, loadLiveKnowledge, refreshLiveKnowledge,
// checkKnowledgeFreshness, and buildMasterSystemPrompt (plus the KNOWLEDGE_*
// cache constants) were extracted verbatim to ./a0Knowledge (Sprint 1, M4).
// They are imported below and re-exported from this file's module.exports so the
// public export surface is unchanged. Behaviour is identical.
// ══════════════════════════════════════════════════════════════════════════════
const {
...
// detectIndustry and estimateCompetition were extracted verbatim to ./a0Industry
// (Sprint 1, M5). detectIndustry is imported below and re-exported from this
// file's module.exports so the public export surface is unchanged. Behaviour is
// identical.
// ══════════════════════════════════════════════════════════════════════════════
const { detectIndustry, estimateCompetition } = require("./a0Industry");
